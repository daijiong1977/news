...
Follows the preview rules: skip video/transcript, clean paragraphs, apply age-13 banned-word filter (mining/age13_banned.txt), download preview image with min 70KB (trusted-host bypass), and collect up to 3 accepted articles per feed from top 20 items.
